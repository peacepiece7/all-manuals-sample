...
function BrandCategoryForm() {
  ...
  const { data, isLoading } = useQuery(["brand category", `${category}${subcategory}`], loadBrandCategories);
  ...
  //           } else {
  //             return (
  //               <li key={v} id={v} className={styles.inactive}>
  //                 {v}
  //               </li>
  //             );
  //           }
  ...
  //               })}
  //         </ul>
  //         {isLoading ? <ul>Loading ...</ul> : <BrandCategoryList></BrandCategoryList>}
  //       </div>
  //     </div>
  //   </div>
  // );
